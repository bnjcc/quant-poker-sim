...
4. **Experiment** (`/experiments/new`) — run solo, combine at least two real-user strategy models with bots, or seat at least three real-user strategy models at a players-only table. Configure blinds, rake, buy-ins, hand count, seed, and (when used) the 14-archetype bot pool.
