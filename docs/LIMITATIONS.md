...
| Opponents | 14 heuristic archetypes with realistic aggregate stats and per-instance jitter | Postflop play is simpler than strong humans; "adaptive" agent only tracks fold rates | Learned policies from hand-history corpora; richer opponent memory |
