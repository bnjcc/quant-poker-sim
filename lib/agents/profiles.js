...
export const AGENT_PRESETS = [
  ...
  {
    ...base,
    id: "selective-aggressor",
    name: "Selective aggressor",
    description:
      "Raises playable hands more often and mixes occasional light 3-bets without playing every hand.",
    vpip: 0.36,
    pfr: 0.28,
    threeBet: 0.5,
    foldToThreeBet: 0.48,
