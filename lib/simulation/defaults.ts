import { TableConfig } from "@/types/poker";
import { PoolSettings } from "@/types/experiment";
import { AGENT_PRESETS, getPreset } from "@/lib/agents/profiles";
import { PoolConfig } from "./table";
...
export const CALIBRATION_SIZES = [25, 50, 100, 250] as const;
