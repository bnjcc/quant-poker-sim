/** Real per-action clock shown to the user during manual calibration. */
export const ACTION_CLOCK_MS = 45_000;
/** Virtual action-time ceiling for heuristic opponents. */
export const OPPONENT_ACTION_CLOCK_MS = 15_000;
